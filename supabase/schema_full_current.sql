...
ALTER TABLE public.conversation_participants ADD COLUMN IF NOT EXISTS archived boolean NOT NULL DEFAULT false;
ALTER TABLE public.conversation_participants ADD COLUMN IF NOT EXISTS folder text NOT NULL DEFAULT 'all';
