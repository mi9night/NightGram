...
export default function ProfilePage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="glass-strong rounded-4xl mx-1 md:mx-4 -mt-6 md:-mt-8 relative z-10 px-4 md:px-6 pb-6 pt-5 overflow-visible">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div className="flex-1 min-w-0 pb-1 pt-2 md:pt-0">
              ...
              <p className="text-white/60 text-sm mt-2 max-w-md">{isBlocked ? "Вы добавили этого пользователя в чёрный список." : safeProfile.deletedAt ? "Аккаунт удалён." : safeProfile.bio}</p>
            </div>
      ...
      {/* Content */}
      <div className={cn("mt-6", isBlocked && !showBlockedContent && "hidden")}>
