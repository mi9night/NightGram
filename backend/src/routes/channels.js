...
async function canAccessChannel(req, channel) {
  ...
  if (await canEditChannel(req, channel)) return true;
...
router.patch("/:id", async (req, res) => {
  ...
  if (result.error && /banner_url|tags|boost_|hide_subscribers|is_private|chat_enabled|chat_conversation_id|schema cache/i.test(result.error.message || "")) {
